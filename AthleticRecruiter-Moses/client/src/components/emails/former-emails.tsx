...
export default function Outreach() {
  ...
  return (
    <div>
            ...
            <div className="grid grid-cols-1 gap-5">
              {emails
                ...
                .map((email) => (
                  <Card
                    key={email.id}
                    className="border border-gray-200 border-l-4 border-l-purple-500"
                  >
                            ...
                            <Button
                              ...
                              onClick={() => {
                                ...
                                if (coach) {
                                  ...
                                  // Pre-fill with reply format
                                  form.reset({
                                    subject: `Re: ${email.subject}`,
                                    body: `\n\n---\nOriginal message from ${coach.firstName} ${coach.lastName}:\n${email.body}`,
                                    enableFollowUp: false,
                                  });
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    ...
                                    received email? This action cannot be
                                    undone.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
      ...
      <GmailPrompt open={showGmailPrompt} onClose={() => setShowGmailPrompt(false)} />
    </div>
  );
}
